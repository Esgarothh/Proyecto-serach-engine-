...
filetoread = open("/home/esgaroth/Downloads/extracted/AOL-user-ct-collection/user-ct-test-collection-01.txt",'r')

count = 0
while True:
    regexx = re.compile('((https?|ftp|gopher|telnet|file):((//)|(\\\\))+[\\w\\d:#@%/;$()~_?\\+-=\\\\\\.&]*)')
